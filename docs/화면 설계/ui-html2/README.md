...
- SRS v0.1 대조 기준: 기능/business logic 구현은 제외하고, 누락된 UI 상태와 진입점만 보강한다. 보강 대상은 8문항 레벨 테스트 표시, AI 시험 대기/실패/결과, AI 분석 실패, 커뮤니티 첨부, 결제 완료 후 추천 진입, 설정 탈퇴 진입이다.
...
| SR-004 | `screens/learning/onboarding.html` | 언어, 목표, 시작점, 8문항 레벨 테스트 |
...
| SR-015 | `screens/settings/index.html`, `screens/settings/profile.html`, `screens/settings/security.html`, `screens/settings/social.html`, `screens/settings/system.html`, `screens/settings/payment.html` | 독립 설정 홈, 회원 정보, 이메일/비밀번호, Google/Kakao 소셜 계정, 시스템 설정, 결제 정보, 탈퇴 진입 |

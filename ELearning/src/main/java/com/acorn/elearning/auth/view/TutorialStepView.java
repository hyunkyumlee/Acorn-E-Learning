...
//nuviPose : IDLE|GREETING|THINKING|STUDYING|EXPLORING|RESTING. null이면 누비 숨김
public record TutorialStepView(
    ...
    // 이미지/누비 없는 단계용 편의 팩토리
    public static TutorialStepView of(int step, String title, String description) {
        return new TutorialStepView(step, title, description, null, null, null, null);
    }

    // 이미지 + 누비 좌표/포즈까지 있는 스텝용 팩토리

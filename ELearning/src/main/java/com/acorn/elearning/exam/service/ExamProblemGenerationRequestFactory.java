        ...
        return new ChatGptRequest(
                ...
                Map.of(
                        "instruction", """
                                ...
                                각 문제는 prompt, starterCode, solutionCode, testCases를 포함합니다. starterCode는 입력을 읽는 기본 틀을 포함하고, 사용자가 구현해야 할 로직 영역만 TODO 주석으로 비워 둡니다. solutionCode는 Markdown 코드 펜스 없이 제공하는 완전한 Java 소스이며, public class Solution의 main 함수에서 입력을 읽고 각 testCases의 expectedOutput과 일치하는 결과를 출력해야 합니다. solutionCode에는 TODO나 미완성 로직을 남기지 마세요. testCases는 input, expectedOutput 필드를 가진 배열입니다.
                                """,

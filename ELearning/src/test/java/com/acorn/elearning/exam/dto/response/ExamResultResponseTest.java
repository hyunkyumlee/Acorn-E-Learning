...
class ExamResultResponseTest {
    ...
    @Test
    void from_parses_ai_review_json_and_hides_starter_code_praise() {
        ...
        answer.setAiReview("""
                {"explanation":"입력 처리와 배열 선언은 올바릅니다. 출력문이 필요합니다.","codeReview":"Scanner 입력은 올바르게 작성하셨습니다. 출력문을 추가하셔야 합니다."}
                """);
        ...
        assertEquals("출력문을 추가하셔야 합니다.", parsedAnswer.codeReview());
    }
}
